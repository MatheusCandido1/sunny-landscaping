...
<script src="https://cdn.rawgit.com/PascaleBeier/bootstrap-validate/v2.2.0/dist/bootstrap-validate.js"></script>
    ...
    <body class="sb-nav-fixed">
        <nav style="background-color: #f5a15c;" class="sb-topnav navbar navbar-expand">
            <a  style="color: white" class="navbar-brand" href="index.html">Sunny Landscaping</a><button class="btn btn-link btn-sm order-1 order-lg-0" style="color: white" id="sidebarToggle" href="#"><i class="fas fa-bars"></i></button
            ><!-- Navbar Search-->
